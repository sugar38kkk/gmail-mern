...
export const newPostForm = {
  to: {
    ...createFormFieldConfig('To', 'to', 'text'),
    validationRules: [requiredRule('to')],
  },
  title: {
...
export let editProfileForm = {
  ...
  phone: {
    ...createFormFieldConfig('Phone Number', 'phone', 'text', 'input', '', true),
    validationRules: [],
  },
};
